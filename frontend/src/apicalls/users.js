...
export const verifyemail = async(payload) => {
    try{
      const response = await axiosInstance.post('/api/users/verifyemail',payload);
      return response.data
    }
    catch(error){
      return error.response.data
...
export const verifyemaillink = async(payload) => {
    try{
      const response = await axiosInstance.post('/api/users/verifyEmailLink',payload);
      return response.data
    }
    catch(error){
      return error.response.data
...
export const updateUserEmail = async(payload) => {
  try{
    const response = await axiosInstance.put('/api/users/update-user-email',payload)
    return response.data
  }
  catch(error){
    return error.response.data
...
export const updateUserPassword = async(payload) => {
  try{
    const response = await axiosInstance.put('/api/users/update-user-password',payload)
    return response.data
  }
  catch(error){
    return error.response.data

...
const editTransaction = async(req,res) => {
   try{
     const transaction = await Transaction.findOne({ _id: req.body._id, user: req.body.userid })
     if(transaction){
...
module.exports = {addTransaction,getAllTransactionsOfUser,editTransaction,deleteTransaction}
